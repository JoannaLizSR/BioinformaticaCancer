...
## Objetivo: 
Este documento tiene como objetivo mostrar que la bioinformática es un excelente aliado a la medicina para entender, desarrollar tratamientos y diagnosticar el cáncer. Centrandonos en México como el contexto de desarrollo del presente trabajo, debido a que es uno de los paises subdesarrollados con mayor indice de cáncer y mortalidad en el mismo.
